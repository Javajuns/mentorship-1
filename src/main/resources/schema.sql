CREATE TABLE PUBLIC.USERS(ID INTEGER GENERATED BY DEFAULT AS IDENTITY(START WITH 1) NOT NULL PRIMARY KEY,LOGIN VARCHAR(35),FIRST_NAME VARCHAR(35),SECOND_NAME VARCHAR(35),EMAIL VARCHAR(35),DATE_CREATED DATE,IS_ADMIN INTEGER);
